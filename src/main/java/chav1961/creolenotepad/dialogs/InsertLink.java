...
public class InsertLink implements FormManager<Object, InsertLink>, ModuleAccessor {
	...
	@Override
	public RefreshMode onField(LoggerFacade logger,final InsertLink inst, final Object id, final String fieldName, final Object oldValue, final boolean beforeCommit) throws FlowException, LocalizationException {
