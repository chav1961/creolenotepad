...
public class FindReplace implements FormManager<Object, FindReplace>, ModuleAccessor {
	...
	public FindReplace(final JCreoleEditor editor) {
		if (editor == null) {
	...
	@Override
	public RefreshMode onField(LoggerFacade logger, FindReplace inst, Object id, String fieldName, Object oldValue, boolean beforeCommit) throws FlowException, LocalizationException {
	...
	@Override
	public RefreshMode onAction(LoggerFacade logger, final FindReplace inst, final Object id, final String actionName, final Object... parameter) throws FlowException, LocalizationException {
		switch (actionName) {
			...
			case "app:action:/FindReplace.replaceAll"	:
				...
				if (count == 0) {
					...
					logger.message(Severity.warning, Application.KEY_APPLICATION_MESSAGE_REPLACED, count);
				}
				break;
			default :
